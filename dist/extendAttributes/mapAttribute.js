...
export default (node) => (keyAndValue) => f.cond([isEvent, addEventListenerPure(node)], [isEventWithStop, addEventListenerWithStop(node)], [isEventWithPrevent, addEventListenerWithPrevent(node)], [isEventWithStopAndPrevent, addEventListenerWithStopAndPrevent(node)], [isClassName, setClassName(node)], [isHtmlFor, setHtmlFor(node)], [f.T, setAttribute(node)])(...keyAndValue);
